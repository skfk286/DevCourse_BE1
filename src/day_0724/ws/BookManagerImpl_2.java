...
public class BookManagerImpl_2 implements IBookManager {

    private Map<String,Book> books = new HashMap<>();
    private static IBookManager instance = new BookManagerImpl_2();
    private BookManagerImpl_2() { // 외부에서 객체 생성을 하지 못하도록 접근 제어자를  private으로 만든 생성자
    }
